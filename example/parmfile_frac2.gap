################################################################################
# Parmfile for Migrate 5.0.2(git:v5.0.2-5-g36240df-dirty)-December-1-2021
# DO NOT REMOVE THE FIRST TWO LINES!
#
# generated automatically on
# Mon Mar 28 16:48:18 2022
#
...
random-seed=AUTO #OWN:412125125
#
...
#-------------------------------------------------------------------------------
#
# Use an alternative to exponential distribution [mittag-leffler]
#   Syntax mittag-leffler-alpha=<NO|YES|YES:ESTIMATE|YES:number>
#   where numbers can have the range of 0.01 to 1.0, (NO=1.0=default=exp distrib)
mittag-leffler-alpha=YES:0.9
#
#-------------------------------------------------------------------------------
#
...
#
updatefreq=0.500000 0.500000 0.000000 0.000000 #tree, parameter haplotype, timeparam updates
bayes-posteriorbins=1500 1500 1500 1500 1500 
bayes-posteriormaxtype=TOTAL
bayes-file=NO
bayes-allfile=YES:1:bayesallfile-fracgap2
...
bayes-priors= SPLIT * * UNIFORMPRIOR: 0.000000 0.100000 0.010000 
bayes-priors= SPLITSTD * * UNIFORMPRIOR: 0.000000 0.100000 0.010000 
#
...
heating=YES:1:{1.000000,1.500000,3.000000,100000.000000}
heated-swap=YES
#
